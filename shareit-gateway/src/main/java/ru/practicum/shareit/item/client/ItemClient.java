...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> postItem(ItemMessageDto dto, long userId) {
        return post("", userId, dto);
    }

    public ResponseEntity<Object> patchItem(ItemMessageDto dto, long userId, long itemId) {
    ...
    public ResponseEntity<Object> saveComment(CommentMessageDto dto, long userId, long itemId) {
