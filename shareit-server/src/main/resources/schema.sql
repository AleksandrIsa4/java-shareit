...
(
    ...
    CONSTRAINT fk_requestor_id_requests FOREIGN KEY (requestor_id) REFERENCES users (id)
);
...
(
    ...
    CONSTRAINT fk_request_id_items FOREIGN KEY (request_id) REFERENCES requests (id)
);
