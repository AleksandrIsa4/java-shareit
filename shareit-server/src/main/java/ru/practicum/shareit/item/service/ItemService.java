...
public class ItemService {
    ...
    public ItemResponseDto get(Long id, Long idUser) {
        ...
        if (item.getOwner().getId().equals(idUser)) {
            ...
            Booking lastBooking = bookingRepository.findTop1ByItemIdAndStartIsBeforeAndStatusIsOrderByStartDesc(id, LocalDateTime.now(), Status.APPROVED);
    ...
    public List<ItemResponseDto> getAll(Long idUser, int from, int size) {
        ...
        for (ItemResponseDto dtoItemBooking : dto) {
            ...
            Booking lastBooking = bookingRepository.findTop1ByItemIdAndStartIsBeforeAndStatusIsOrderByStartDesc(dtoItemBooking.getId(), LocalDateTime.now(), Status.APPROVED);
